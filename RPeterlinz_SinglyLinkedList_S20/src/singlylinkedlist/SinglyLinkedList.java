...
public interface SinglyLinkedList {
	...
	/**
	 * @return a comma-separated String of the values in the list. Don't add any
	...
	/**
	 * Loads text from file into new nodes in the list; one line from the file
	 * becomes one node in the list. For example, if the file looks like this:
	 * 
	 * <pre>
	 * These are
	 * the days
	...
	/**
	 * Saves values from the nodes in the list to the specified file; one line in
	 * the file for each node in the list.
	 * 
	 * @param filename
	 *            Path to the file
	 * @throws IOException
